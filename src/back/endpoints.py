...
def get_recipes():
    ...
    # Formatage
    recipes_list = [
        {"id": recipe.id, "name": recipe.name, "difficulty": recipe.difficulty, "image_url": recipe.image_url}
...
def get_shopping_list():
    ...
    shopping_items = [
        { "user_id": item.user_id, "category_id": item.category_id, "amount": item.amount}
...
def get_contacts():
    ...
    contacts_list = [
        {"id": contact.id, "user_id": contact.user_id, "name": contact.name, "phone_number": contact.phone_number, "image_url": contact.image_url}
